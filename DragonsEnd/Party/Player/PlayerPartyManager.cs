    ...
    public class PlayerPartyManager : BasicPartyManager
    {
        ...
        public virtual void LootMessageHandler(IMessageEnvelope message)
        {
            ...
            foreach (var targetActor in data.TargetActors)
            {
                ...
                // foreach (var loot in data.IndividualLoot)
                // {
                //     if (targetActor.IsAlive)
                //     {
                //         switch (targetActor.CombatStyle)
                //         {
                //             case CombatStyle.Melee:
                //                 targetActor.ActorSkills?.MeleeSkill.Leveling.GainExperience(loot.CombatExperience);
                //                 break;
                //             case CombatStyle.Ranged:
                //                 targetActor.ActorSkills?.RangedSkill.Leveling.GainExperience(loot.CombatExperience);
                //                 break;
                //             case CombatStyle.Magic:
                //                 targetActor.ActorSkills?.MagicSkill.Leveling.GainExperience(loot.CombatExperience);
                //                 break;
                //             case CombatStyle.Hybrid:
                //                 var sharedExp = loot.CombatExperience / 3;
                //                 targetActor.ActorSkills?.MeleeSkill.Leveling.GainExperience(sharedExp);
                //                 targetActor.ActorSkills?.RangedSkill.Leveling.GainExperience(sharedExp);
                //                 targetActor.ActorSkills?.MagicSkill.Leveling.GainExperience(sharedExp);
                //                 break;
                //         }
                //
                ...
                //                     break;
                //                 case SkillType.Melee:
                //                     targetActor.ActorSkills?.MeleeSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Ranged:
                //                     targetActor.ActorSkills?.RangedSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Magic:
                //                     targetActor.ActorSkills?.MagicSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Alchemy:
                //                     targetActor.ActorSkills?.AlchemySkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Cooking:
                //                     targetActor.ActorSkills?.CookingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Crafting:
                //                     targetActor.ActorSkills?.CraftingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Enchanting:
                //                     targetActor.ActorSkills?.EnchantingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Fishing:
                //                     targetActor.ActorSkills?.FishingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Fletching:
                //                     targetActor.ActorSkills?.FletchingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Foraging:
                //                     targetActor.ActorSkills?.ForagingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Mining:
                //                     targetActor.ActorSkills?.MiningSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Smithing:
                //                     targetActor.ActorSkills?.SmithingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Ranching:
                //                     targetActor.ActorSkills?.RanchingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //                 case SkillType.Woodcutting:
                //                     targetActor.ActorSkills?.WoodcuttingSkill.Leveling.GainExperience(skill.Experience);
                //                     break;
                //             }
                //         }
                //     }
                ...
                // foreach (var sourceActor in data.SourceActors)
                // {
                //     if(sourceActor.HasAlreadyBeenLooted) continue;
                //     // foreach (var loot in data.IndividualLoot)
                //     // {
                //     //     SharedInventory?.Gold.Add(otherCurrency: loot.Gold);
                //     //     SharedInventory?.Items.AddRange(collection: loot.Items);
                //     //     var itemsString = loot.Items.Count is > 0 and > 1 ? "Items" : "Item";
                //     //     var lootItemsDisplay = loot.Items.Count > 0
                //     //         ? $"{loot.Items.Count} {itemsString} from {sourceActor.Name}\n" + string.Join(separator: ", \n", values: loot.Items.Select(selector: x => "Looted " + x.Name))
                //     //         : "No Items";
                //     //     Console.WriteLine(value: $"The party has looted {loot.Gold} and {lootItemsDisplay}");
                //     // }
                //     
                // }
            }
