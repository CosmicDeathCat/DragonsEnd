...
namespace DragonsEnd.Stats.Stat
{
    ...
    public class LongStat
    {
        ...
        public long CurrentValue
        {
            get => _currentValue;
            set => _currentValue =
                Math.Clamp(value, long.MinValue, MaxValue); // Ensures CurrentValue never exceeds MaxValue.
        }
        ...
        public static LongStat operator /(LongStat a, LongStat b)
        {
            return b.CurrentValue != 0
                ...
                new LongStat(a.CurrentValue / b.CurrentValue, a.BaseValue / b.BaseValue)
                : new LongStat(0, a.BaseValue / (b.BaseValue == 0 ? 1 : b.BaseValue)); // Handle zero division safely.
        }
